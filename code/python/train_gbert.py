...
DEFAULT_DATA = ROOT / "data" / "processed" / "german_segments.csv"
DEFAULT_OUTPUT = ROOT / "output" / "models" / "gbert_label_classifier"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Fine-tune deepset/gbert-base on German coded segments.",
        allow_abbrev=False,
    )
